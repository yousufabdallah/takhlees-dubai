...
إذا كانت قاعدتك منشأة من نسخة سابقة من `schema.sql`، طبّق بدلاً من ذلك ملفات الـ migrations الثمانية التالية فقط من المجلد `supabase/migrations/`، **بهذا الترتيب الزمني**:
...
الملفات 1–3 كانت ناقصة من `schema.sql` السابق، والملفات 4–8 هي تحديثات الحماية الجديدة للإنتاج. إذا كنت قد طبّقت الملفات 1–7 سابقاً فطبّق الملف 8 فقط.
...
- طبّق الملفات الثمانية **قبل** تشغيل النسخة الجديدة من التطبيق، لأن تعديل المعاملات يعتمد على الدالة التي يضيفها الملف 4.
